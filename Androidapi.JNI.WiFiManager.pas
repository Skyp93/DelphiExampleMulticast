...
uses
  ...
  Androidapi.JNIBridge, Androidapi.JNI, Androidapi.JNI.JavaTypes,
  Androidapi.JNI.Net, Androidapi.JNI.Java.Net,
  Androidapi.JNI.Os, FMX.Helpers.Android,
  Androidapi.JNI.GraphicsContentViewText, Androidapi.Helpers, SysUtils,
  system.classes;
{$ENDIF}
{$IFDEF ANDROID}
...
type
  ...
  // android.net.MultiCastSocket
  JScanResultClass = interface(JObjectClass)
    ['{5AEBB13C-C013-47CB-B120-F3D1FCFF9BE8}']
  end;

  JMultiCastSocket = interface(Jobject)
    ['{9E23274E-249A-4DC8-9405-D0F3D6FAA456}']
  end;

  [JavaSignature('android/net/MulticastSocket')]
  JMultiCastSocketClass = interface(Jobject)
    ['{E95E6E2D-BEA9-4A28-AE75-C7914A14C566}']
    procedure joinGroup(addres: JInetAddress);

  end;

  TJMultiCastSocket = class(TJavaGenericImport<JNetworkInterfaceClass,
    JNetworkInterface>)
  end;
  ...
  JWifiConfiguration = interface(Jobject)
    ...
    property wepKeys: TJavaObjectArray<JString> read _GetwepKeys
      write _SetwepKeys;
    property wepTxKeyIndex: Integer read _GetwepTxKeyIndex
      write _SetwepTxKeyIndex;
  end;
  ...
  TJWifiConfigurationAuthAlgorithm = class
    (TJavaGenericImport<JWifiConfigurationAuthAlgorithmClass,
    JWifiConfigurationAuthAlgorithm>)
  end;
  ...
  TJWifiConfigurationGroupCipher = class
    (TJavaGenericImport<JWifiConfigurationGroupCipherClass,
    JWifiConfigurationGroupCipher>)
  end;
  ...
  TJWifiConfigurationKeyMgmt = class
    (TJavaGenericImport<JWifiConfigurationKeyMgmtClass,
    JWifiConfigurationKeyMgmt>)
  end;
  ...
  TJWifiConfigurationPairwiseCipher = class
    (TJavaGenericImport<JWifiConfigurationPairwiseCipherClass,
    JWifiConfigurationPairwiseCipher>)
  end;
  ...
  TJWifiConfigurationProtocol = class
    (TJavaGenericImport<JWifiConfigurationProtocolClass,
    JWifiConfigurationProtocol>)
  end;
  ...
  TJWifiConfigurationStatus = class
    (TJavaGenericImport<JWifiConfigurationStatusClass,
    JWifiConfigurationStatus>)
  end;
  ...
  JWifiManagerClass = interface(JObjectClass)
    ...
    { Methods }
    function calculateSignalLevel(rssi: Integer; numLevels: Integer)
      : Integer; cdecl;
    function compareSignalLevel(rssiA: Integer; rssiB: Integer): Integer; cdecl;
    { Properties }
    property ACTION_PICK_WIFI_NETWORK: JString
      read _GetACTION_PICK_WIFI_NETWORK;
    ...
    property EXTRA_PREVIOUS_WIFI_STATE: JString
      read _GetEXTRA_PREVIOUS_WIFI_STATE;
    property EXTRA_SUPPLICANT_CONNECTED: JString
      read _GetEXTRA_SUPPLICANT_CONNECTED;
    ...
    property NETWORK_IDS_CHANGED_ACTION: JString
      read _GetNETWORK_IDS_CHANGED_ACTION;
    property NETWORK_STATE_CHANGED_ACTION: JString
      read _GetNETWORK_STATE_CHANGED_ACTION;
    property RSSI_CHANGED_ACTION: JString read _GetRSSI_CHANGED_ACTION;
    property SCAN_RESULTS_AVAILABLE_ACTION: JString
      read _GetSCAN_RESULTS_AVAILABLE_ACTION;
    property SUPPLICANT_CONNECTION_CHANGE_ACTION: JString
      read _GetSUPPLICANT_CONNECTION_CHANGE_ACTION;
    property SUPPLICANT_STATE_CHANGED_ACTION: JString
      read _GetSUPPLICANT_STATE_CHANGED_ACTION;
    property WIFI_MODE_FULL: Integer read _GetWIFI_MODE_FULL;
    property WIFI_MODE_SCAN_ONLY: Integer read _GetWIFI_MODE_SCAN_ONLY;
    property WIFI_STATE_CHANGED_ACTION: JString
      read _GetWIFI_STATE_CHANGED_ACTION;
  ...
  JWifiManager = interface(Jobject)
    ...
    function createMulticastLock(tag: JString)
      : JWifiManagerMulticastLock; cdecl;
    function createWifiLock(tag: JString): JWifiManagerWifiLock; cdecl;
      overload;
    function createWifiLock(lockType: Integer; tag: JString)
      : JWifiManagerWifiLock; cdecl; overload;
    function disableNetwork(netId: Integer): Boolean; cdecl;
    function disconnect: Boolean; cdecl;
    function enableNetwork(netId: Integer; disableOthers: Boolean)
      : Boolean; cdecl;
    function getConfiguredNetworks: JList; cdecl;
    function getConnectionInfo: JWifiInfo; cdecl;
    // function getDhcpInfo: JDhcpInfo; cdecl; // Íå ðåàëèçîâàíî
  ...
  TJWifiManagerMulticastLock = class
    (TJavaGenericImport<JWifiManagerMulticastLockClass,
    JWifiManagerMulticastLock>)
  end;
  ...
  TJWifiManagerWifiLock = class(TJavaGenericImport<JWifiManagerWifiLockClass,
    JWifiManagerWifiLock>)
  end;
  ...
  TJSupplicantState = class(TJavaGenericImport<JSupplicantStateClass,
    JSupplicantState>)
  end;

function GetWiFiManager: JWifiManager;
function GetAllLocalIndexList(aOnlyIp4: Boolean): tstringlist;
{$ENDIF}
...
begin
  ...
  begin
    LInterface := TJNetworkInterface.Wrap
      (TAndroidHelper.JObjectToID(LInterfaces.nextElement));
    LAddresses := LInterface.getInetAddresses;

    while LAddresses.hasMoreElements do
    begin
      LAddress := TJInetAddress.Wrap
        (TAndroidHelper.JObjectToID(LAddresses.nextElement));
